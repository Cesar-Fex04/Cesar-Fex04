...
Soy estudiante de Ingeniería en Sistemas de Información en la Universidad de Sonora, con sólida formación técnica en programación desde bachillerato <!--[cite: 1] -->. Mi experiencia se ha enfocado principalmente en el desarrollo de software, pero tengo un gran interés en profundizar en el análisis, la ciencia y la ingeniería de datos <!--[cite: 1] -->. 
...
### 🏆 Certificaciones
* **AWS Academy Graduate:** Cloud Developing | Microservices and CI/CD Pipeline Builder <!--[cite: 1] -->
* **GitHub Foundations** <!--[cite: 1] -->
* **Tecnico en Programacion Cédula Profesional (SEP) – No. 15816884**
...
![K-Means](https://img.shields.io/badge/K--Means-FF6F00?style=for-the-badge&logo=scikit-learn&logoColor=white)
![Neural Networks](https://img.shields.io/badge/Neural_Networks-FF6F00?style=for-the-badge&logo=tensorflow&logoColor=white)
![ETL](https://img.shields.io/badge/ETL-02569B?style=for-the-badge&logo=databricks&logoColor=white)
...
* 💰 **FinTrack:** Colaboré en el diseño y desarrollo de una app de finanzas personales usando ASP.NET MVC, SQL Server (Dapper) y dashboards interactivos con Chart.js <!--[cite: 1] -->.
* 🤖 **Clasificador de Spam en SMS:** Entrené un modelo de machine learning en Python utilizando Linear SVM, alcanzando métricas de F1=0.9463 y AUC=0.9938 <!--[cite: 1] -->.
* ☁️ **UNISON Store:** Diseñé una arquitectura en la nube escalable en AWS utilizando VPC, Auto Scaling Groups y bases de datos RDS MySQL <!--[cite: 1] -->.
* 🎮 **Carrito Run:** Formé parte del desarrollo de un juego móvil utilizando Flutter y Flame, implementando mecánicas de niveles y efectos de partículas <!--[cite: 1] -->.
* 💬 **RetroWall:** Construí un muro de comentarios estilo retro consumiendo una API REST protegida con JWT Auth en Angular <!--[cite: 1] -->.
